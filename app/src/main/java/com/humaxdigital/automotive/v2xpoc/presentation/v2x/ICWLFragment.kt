...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentIcwLBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class ICWLFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_icw_l,
            container, false) as FragmentIcwLBinding)
        bind.vm = vm
