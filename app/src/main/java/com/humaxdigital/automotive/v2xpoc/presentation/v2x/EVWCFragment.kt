...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentEvwCBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class EVWCFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_evw_c,
            container, false) as FragmentEvwCBinding)
        bind.vm = vm
