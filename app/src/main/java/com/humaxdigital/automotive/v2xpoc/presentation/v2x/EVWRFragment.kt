...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentEvwRBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class EVWRFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_evw_r,
            container, false) as FragmentEvwRBinding)
        bind.vm = vm
