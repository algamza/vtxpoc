...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentEvwLBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class EVWLFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_evw_l,
            container, false) as FragmentEvwLBinding)
        bind.vm = vm
