...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentBswBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class BSWFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_bsw,
            container, false) as FragmentBswBinding)
        bind.vm = vm
