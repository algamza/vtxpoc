...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentRwwLrBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class RWWLRFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_rww_lr,
            container, false) as FragmentRwwLrBinding)
        bind.vm = vm
