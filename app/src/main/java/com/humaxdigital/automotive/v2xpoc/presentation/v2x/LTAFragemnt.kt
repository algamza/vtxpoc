...
import com.humaxdigital.automotive.v2xpoc.databinding.FragmentLtaBinding
import com.humaxdigital.automotive.v2xpoc.presentation.entities.V2XPUSHED
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class LTAFragemnt : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bind = (DataBindingUtil.inflate(inflater, R.layout.fragment_lta,
            container, false) as FragmentLtaBinding)
        bind.vm = vm
